program test_fdaray
	...
	call fdaray(t,rho,freq,aray)
	print *,t,rho,freq,aray
...
subroutine fdaray(t,rho,freq, aray)

	implicit none
 
    real(4), parameter :: pi=3.141593
	real(4), parameter :: f0=17.97510
	real(4), parameter :: salinity=0.

	real(4) t,rho,freq,aray
	real(4) sst,wavlen
 ...
 !     debye law (2 relaxation wavelengths)
	...
	aray=6*pi*rho*aimag((1-permit)/(2+permit))/wavlen

    return
end


! this routine is from goemod8c.f
