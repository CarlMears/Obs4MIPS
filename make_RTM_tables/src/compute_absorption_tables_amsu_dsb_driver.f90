...
program make_absorption_table
    ...
    use make_absorption_table_t_q, only: compute_absorption_tables_amsu_dsb
...
111   format('/mnt/m/Obs4MIPs/make_RTM_tables/data/abs_tables/amsu_',i2.2,'_abs_table_q.',i1,'.',i1,'.dat')
...
112   format('/mnt/m/Obs4MIPs/make_RTM_tables/data/abs_tables/amsu_',i2.2,'_abs_table_q_per_Pa.',i1,'.',i1,'.dat')
